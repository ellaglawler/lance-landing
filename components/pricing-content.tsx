...
function BetaCountdown() {
  ...
  return (
    <div className="flex flex-col items-center mb-2">
      <div className="flex items-center gap-2 text-orange-400 font-bold text-sm bg-orange-900/30 px-3 py-1 rounded-full mb-1">
        <span>Beta ends in</span>
        <span className="tabular-nums">
          {timeLeft.days}d {timeLeft.hours}h {timeLeft.minutes}m {timeLeft.seconds}s
        </span>
      </div>
      <div className="text-xs text-orange-300">Beta ends August 31, 2025</div>
    </div>
  );
}
                ...
                <Card className="relative border-slate-700 bg-slate-800/50">
                  ...
                  <CardHeader className="text-center">
                    ...
                    <p className="text-xs text-orange-400 font-semibold mt-1">
                      Beta ends soon — upgrade to keep access.
                    </p>
                  </CardHeader>
